...
```
 16:15:08 - PID: 3808 JVM: 1.8.0_171 USER: zed UPTIME: 05m28s
  PROCESS: 0.00% cpu(0.00% of 8 core)
  THREAD: 11 live, 8 daemon, 11 peak, 0 new | CLASS: 1825 loaded, 0 unloaded, 0 new
  HEAP: 34m/64m/1344m eden, 0m/10m sur, 0m/171m/2731m old
  NON-HEAP: 10m/10m/NaN metaspace, 3m/3m/240m codeCache, 1m/1m/1024m ccs
  OFF-HEAP: 0m/0m direct(max=NaN), 0m/0m map(count=0), 11m threadStack
  ...
  VMARGS: -agentlib:jdwp=transport=dt_socket,address=127.0.0.1:51487,suspend=y,server=n -javaagent:/Users/zed/Library/Caches/IntelliJIdea2018.2/captureAgent/debugger-agent.jar=file:/private/var/folders/qf/r9qq_q9j505d6f8j4qp18gg00000gn/T/capture1.props -Dfile.encoding=UTF-8
